        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{url('dashboard')}}" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="{{url('subcategory')}}" class="breadcrumb-link">Sub Catgeory List</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
              ...
              <!-- ============================================================== -->
                                    ...
                                    <form id="form" data-parsley-validate="" novalidate="" action="{{url('subcategory/update')}}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input id="inputEmail2" type="text" value="{{$subcategory->name}}" name="name" required="" data-parsley-type="email" placeholder="Enter your name" class="form-control">
                                                @error('name')
                                                 <div class="error text-danger mt-2">{{ $message }}</div>
                                                 @enderror
