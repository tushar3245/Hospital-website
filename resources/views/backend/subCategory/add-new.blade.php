        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{url('dashboard')}}" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="{{url('category')}}" class="breadcrumb-link">Sub Catgeory List</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
              ...
              <!-- ============================================================== -->
                                    ...
                                    <form id="form" data-parsley-validate="" novalidate="" action="{{url('sub-category/stor')}}" method="post">
                                        @csrf
