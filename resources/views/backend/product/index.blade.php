                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <td>{{$product->price}} ({{$product->discounted_price}})</td>
                                                ...
                                                <td><a href="{{url('product/edit',$product->id)}}" class= "btn btn-info">Edit</a><a onclick ="return confirm('Are you sure delete this item')"href="{{url('product/delete',$product->id)}}"  class="btn btn-danger">Delete</a></td>
                                            </tr>
                                          @endforeach
                                        </tbody>
                                    </table>
