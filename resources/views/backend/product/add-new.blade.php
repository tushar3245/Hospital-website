                                    ...
                                    <form id="form" data-parsley-validate="" novalidate="" action="{{url('product/store')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input id="inputEmail2" type="text" name="name" required="" data-parsley-type="email" placeholder="Enter your name" class="form-control">
                                                @error('name')
...
<select class="browser-default custom-select" name="subcategory" id="subcategory">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input id="inputEmail2" type="number" name="price" required="" data-parsley-type="email" placeholder="Enter  product price" class="form-control">
                                                @error('price')
                                                 <div class="error text-danger mt-2">{{ $message }}</div>
                                                 @enderror 
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input id="inputEmail2" type="number" name="discounted_price" required="" data-parsley-type="email" placeholder="Enter  product discounted price" class="form-control">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input id="inputEmail2" type="file" name="image" required="" data-parsley-type="email" placeholder="Enter  product image" class="form-control">
                                                @error('image')
                                                 <div class="error text-danger mt-2">{{ $message }}</div>
                                                 @enderror 
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <textarea id="inputEmail2" type="text" name="description"    required="" class="form-control summernote"></textarea>
