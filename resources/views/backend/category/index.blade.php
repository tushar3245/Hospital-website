                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="table-primary">
                                                ...
                                                <td><a href="{{url('category/edit',$category->id)}}" class= "btn btn-info">Edit</a><a onclick ="return confirm('Are you sure delete this item')"href="{{url('category/delete',$category->id)}}"  class="btn btn-danger">Delete</a></td>
                                            </tr>
                                          @endforeach
                                        </tbody>
                                    </table>
